...
namespace BYOJoystick.Managers
{
    public class T55FrontManager : Manager
    {
        ...
        protected override void CreateFlightControls()
        {
            ...
            FlightButton("Landing Gear Up", "Landing Gear (Front)", ByManifest<VRLever, CLever>, CLever.Set, 1, i: 8);
            FlightButton("Landing Gear Down", "Landing Gear (Front)", ByManifest<VRLever, CLever>, CLever.Set, 0, i: 8);
        ...
        protected override void CreateSystemsControls()
        {
            ...
            SystemsButton("Engine Toggle", "Switch Cover (Engine) (Front)", ByManifest<VRLever, CLeverCovered>, CLeverCovered.Cycle, i: 3);
            SystemsButton("Engine On", "Switch Cover (Engine) (Front)", ByManifest<VRLever, CLeverCovered>, CLeverCovered.Set, 1, i: 3);
            SystemsButton("Engine Off", "Switch Cover (Engine) (Front)", ByManifest<VRLever, CLeverCovered>, CLeverCovered.Set, 0, i: 3);
        ...
        protected override void CreateRadioControls()
        {
            ...
            RadioButton("Radio Channel Freq", "Radio Channel (Rear)", ByManifest<VRTwistKnobInt, CKnobInt>, CKnobInt.Set, 1, i: 6);
            RadioButton("Radio Channel Global", "Radio Channel (Rear)", ByManifest<VRTwistKnobInt, CKnobInt>, CKnobInt.Set, 2, i: 6);
        ...
        protected override void CreateLightsControls()
        {
            ...
            LightsButton("Formation Lights Toggle", "Formation Lights (Front)", ByName<VRLever, CLever>, CLever.Cycle);
            LightsButton("Formation Lights On", "Formation Lights (Front)", ByName<VRLever, CLever>, CLever.Set, 1);
            LightsButton("Formation Lights Off", "Formation Lights (Front)", ByName<VRLever, CLever>, CLever.Set, 0);
        ...
        protected override void CreateMiscControls()
        {
            ...
            MiscButton("Fuel Dump Toggle", "Switch Cover (Fuel Dump) (Front)", ByManifest<VRLever, CLeverCovered>, CLeverCovered.Cycle, i: 27);
            MiscButton("Fuel Dump On", "Switch Cover (Fuel Dump) (Front)", ByManifest<VRLever, CLeverCovered>, CLeverCovered.Set, 1, i: 27);
            MiscButton("Fuel Dump Off", "Switch Cover (Fuel Dump) (Front)", ByManifest<VRLever, CLeverCovered>, CLeverCovered.Set, 0, i: 27);

            MiscButton("Jettison Execute", "Switch Cover (Jettison) (Front)", ByManifest<VRLever, CButtonCovered>, CButtonCovered.Use, i: 12);
